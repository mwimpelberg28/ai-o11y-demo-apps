...
> **No cluster yet? Need EKS?** [`terraform/`](terraform/) provisions a ready-to-use EKS cluster (VPC, managed node group, and the EBS CSI driver with its IAM role) so the Postgres PVC below binds out of the box.
